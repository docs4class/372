...
\hypertarget{proect-e1}{%
\chapter{Proect (E1)}\label{proect-e1}}
...
\tightlist
\item
  Make sure you can define the terms below outbound, in your own words, so that they make sense both to you and to someone else (me?). Actually practice saying and defining these terms outloud until your answers make sense:
\end{enumerate}
